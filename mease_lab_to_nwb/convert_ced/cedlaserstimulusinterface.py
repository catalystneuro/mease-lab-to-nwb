...
class CEDLaserStimulusInterface(CEDRecordingInterface):
    """Primary data interface class for converting CED laser stimuli."""
    ...
    def run_conversion(self, nwbfile: NWBFile, metadata: dict = None, stub_test: bool = False):
        ...
        nwbfile.add_stimulus(
            TimeSeries(
                ...
                description="TTL command for cortical laser stimulus."
            )
        )
